...
class _$_Employee_Detail implements _Employee_Detail {
  ...
  @override
  String toString() {
    return 'Employee_Detail(id: $id, name: $name, email: $email, cancel__contract_date: $cancel__contract_date, phone: $phone, avatar: $avatar)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, email, cancel__contract_date, phone, avatar);
